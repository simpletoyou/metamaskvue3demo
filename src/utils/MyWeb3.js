 ...
 * @version: 
 * @Author: simpletoyou
 * @Date: 2022-04-24 18:38:46
 * @LastEditors: simpletoyou
 * @LastEditTime: 2022-04-24 18:50:22
 */
...
const MyWeb3 ={
            ...
            ethereum.enable().then(function (accounts) {
                ...
                window.web3.eth.net.getId().then(function (result) {
                    ...
                    if(currentContractAddress !== undefined){
                        ...
                        console.log('window.defaultAccount',window.defaultAccount)
    ...
    getZombiesByOwner(){
        return new Promise((resolve, reject) => {
            window.MyContract.methods.getZombiesByOwner('0x7693005b78BFA0e57EA3676CC4938D360664Fcf3').call().then(function(zombies) {
